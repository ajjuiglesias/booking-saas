...
export default function BookingNotificationEmail({
  ...
  const previewText = `New booking from ${customerName} for ${serviceName}`
        ...
        <Container style={container}>
          ...
          {notes && (
            <Section style={section}>
              <Heading style={h3}>Customer Notes</Heading>
              <Text style={notesText}>{notes}</Text>
            </Section>
          )}

          <Section style={buttonSection}>
            <Button style={button} href={`${process.env.NEXT_PUBLIC_APP_URL}/dashboard/calendar`}>
              View in Dashboard
            </Button>
          </Section>
